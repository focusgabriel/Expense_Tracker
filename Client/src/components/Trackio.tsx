          ...
          <span className="relative inline-block w-[0.72em] h-[0.85em] self-center text-3xl">
            ...
            >
              <defs>
                ...
                <linearGradient id="blueGradBox" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <linearGradient id="foldGradBox" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#00E5FF" />
                  <stop offset="100%" stopColor="#0040E6" />
                </linearGradient>

                {/* Soft Drop Shadow */}
                <filter id="subtleShadowBox" x="-10%" y="-10%" width="130%" height="130%">
                  <feDropShadow dx="2" dy="4" stdDeviation="3" floodColor="#0040E6" floodOpacity="0.25" />
                </filter>
              </defs>
