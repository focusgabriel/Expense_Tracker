...
const Card = ({
  ...
  return (
    <Link to={`/edit/${id}`}>
      <div className="grid w-full grid-cols-[2rem_minmax(0,1fr)_auto] items-center gap-2.5 border-b border-slate-100 px-3 py-2.5 transition last:border-b-0 hover:bg-slate-50 cursor-pointer">
        ...
        <div className="min-w-0">
          <div className="flex min-w-0 items-center gap-2">
            ...
            <span className="rounded-full bg-slate-100 px-1.5 py-0.5 text-[9px] font-semibold uppercase leading-4 text-slate-500">
              {type}
            </span>
          </div>
        ...
        <div className="text-right">
          <h4
            className={`${type === "expense" ? "text-red-600 before:content-['-']" : "before:content-['+'] text-green-500"} whitespace-nowrap text-sm font-bold`}
          >
            &#8358;{amount}
          </h4>
