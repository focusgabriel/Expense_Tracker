...
import { ForgotPasswordController, getCurrentUserController, logoutController, ResetPasswordController, verifyEmailController } from "../controllers/auth.controllers.js";
